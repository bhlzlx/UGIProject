...
namespace ugi {
    ...
    void RenderCommandEncoder::drawIndexed( Drawable* drawable, uint32_t indexOffset, uint32_t indexCount ) {
        drawable->bind(_commandBuffer);
        vkCmdDrawIndexed( *_commandBuffer, indexCount, 1, indexOffset, 0, 0 );
    }
