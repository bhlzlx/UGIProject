...
elseif(WIN32)
    if(MSVC)
        ...
        set(CMAKE_CXX_FLAGS         "${CMAKE_CXX_FLAGS} /std:c++20 /bigobj /utf-8")
        set(CMAKE_CXX_FLAGS_DEBUG   "${CMAKE_CXX_FLAGS_DEBUG} /std:c++20 /Od /bigobj /utf-8")
        set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /std:c++20 /bigobj /fp:fast /Gy /Oi /Oy /O2 /Ot /Zi /EHsc /utf-8")
